...
function withoutEmptyStrings(input: NodeJS.ProcessEnv): Record<string, string | undefined> {
...
export const env: Env = envSchema.parse(withoutEmptyStrings(process.env));
